...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(120,100%,90%,var(--card-opacity)) 4%,hsla(120,50%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(120,25%,70%,calc(var(--card-opacity)*0.5)) 50%,hsla(120,0%,60%,0) 100%),radial-gradient(35% 52% at 55% 20%,#00ff88c4 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#00ff88ff 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#00ff88ff 0%,#00c6ffff 40%,#00c6ffff 60%,#00ff88ff 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  iconUrl = '/logo.jpg',
  grainUrl = 'https://picsum.photos/seed/grain/200/200',
  behindGradient,
  innerGradient,
