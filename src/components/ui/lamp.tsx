  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-green-300 to-emerald-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Future Work
      </motion.h1>
      <motion.div
        ...
        className="mt-8 inline-block bg-gradient-to-br from-white via-white to-gray-50 border-4 border-green-400 rounded-2xl px-12 py-6 shadow-2xl hover:shadow-green-500/40 hover:shadow-3xl transition-all duration-500 hover:scale-110 hover:border-green-500"
        whileHover={{ 
          scale: 1.1,
          transition: { duration: 0.3 }
        }}
      >
        <span className="bg-gradient-to-r from-green-600 via-green-500 to-emerald-600 bg-clip-text text-transparent font-black text-3xl md:text-5xl tracking-wide drop-shadow-lg">
          YOUR WEBSITE
        </span>
      </motion.div>
    </LampContainer>
