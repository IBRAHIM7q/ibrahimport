...
const GlowingOrbitPath = memo(({ radius, glowColor = 'blue' }: GlowingOrbitPathProps) => {
  const glowColors = {
    blue: {
...
export default function OrbitingSkills() {
  ...
  const orbitConfigs: Array<{ radius: number; glowColor: GlowColor }> = [
    { radius: 100, glowColor: 'blue' },
    { radius: 180, glowColor: 'lightblue' }
  ];
